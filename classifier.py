...
def main(argv):
	...
	print 'Dimensions to reach 99% of variation:', i

	cheaders = pcadata.getDataHeaders()[:i]

	# cluster the data
	K = 6

	# Use the average of each category as the initial means
	truecats = catdata.getData(catdata.getHeaders()[0:1])
	tmpcats = truecats - 1
